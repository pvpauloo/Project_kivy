...
class ModuloProcessamento:
    ...
    def Geral(self, opc):
        diretorio = listdir(r'C:\Users\u300310\OneDrive - HUB FINTECH S A\PycharmProjects\Project_Kivy\Project_Kivy\logs_q2')
        dicionario = dict()
        conjunto = []
        field39 = ''
        for file in diretorio:
            arquivo = open(f'C:\\Users\\u300310\\OneDrive - HUB FINTECH S A\\PycharmProjects\\\Project_Kivy\\\Project_Kivy\\logs_q2\\{file}', 'r', encoding='utf-8')
            v = True
            while v:
                ...
                if linha.__contains__('<'):
                    if linha.__contains__('<log realm="mastercard-channel/'):
                        ...
                        if linha.__contains__('<field id="0" value="0420"/>') or linha.__contains__('<field id="0" value="0100"/>') or linha.__contains__('<field id="0" value="0400"/>') or linha.__contains__('<field id="0" value="0110"/>'):
